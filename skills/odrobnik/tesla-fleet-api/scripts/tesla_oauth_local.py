...
Typical flow:
  1) put TESLA_CLIENT_ID / TESLA_CLIENT_SECRET into ~/.bot/tesla-fleet-api/.env
...
def main() -> int:
    ...
    ap.add_argument("--dir", default=default_dir(), help="Config directory (default: ~/.bot/tesla-fleet-api)")
