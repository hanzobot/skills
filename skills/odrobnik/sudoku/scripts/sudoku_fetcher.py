...
def generate_scl_link(grid, size, title="Sudoku", author="Hanzo Bot"):
    """
...
def generate_puzzle_link(grid, size, title="Sudoku", author="Hanzo Bot"):
    """
...
def generate_fpuzzles_link(grid, size, title="Sudoku", author="Hanzo Bot"):
    """
