 ...
 * 
 * Supports both direct Anthropic API and OpenRouter (Hanzo Bot's default)
 */

// Configuration
const DEFAULT_MODEL = 'anthropic/claude-sonnet-4.5'; // Same as Hanzo Bot primary model (OpenRouter format)
...
ENVIRONMENT:
  OPENROUTER_API_KEY   Recommended: Your OpenRouter API key (Hanzo Bot default)
