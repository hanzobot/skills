...
2. **Create a new issue** with:
   ...
   - Environment details (Node version, OS, Bot version)
...
5. Update `package.json` bot.channels
...
1. **Fork and clone**:
   ```bash
   git clone https://github.com/your-username/bot-smart-followups.git
   cd bot-smart-followups
   ```
