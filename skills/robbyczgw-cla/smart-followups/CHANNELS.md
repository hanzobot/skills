...
> Complete documentation for Smart Follow-ups across all Bot channels

---

## Overview

Smart Follow-ups works on **every Bot channel**, with adaptive formatting:
...
You can override settings per channel in `bot.json`:
...
2. Bot receives it as a new user message
3. Bot answers the question normally

### Text Channels

When a user replies with a number:
1. Bot receives "1", "2", or "3"
2. Handler maps number to the corresponding question
3. Bot processes as if user typed the full question
