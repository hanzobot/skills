...
metadata: {"bot":{"emoji":"🧩","requires":{"anyBins":["claude","codex","opencode","pi"]}}}
---
...
- Either use the project where the PR is submitted (if it's NOT ~/Projects/bot)
...
7. **NEVER start Codex in ~/bot/** — it'll read your soul docs and get weird ideas about the org chart! Use the target project dir or /tmp for blank slate chats
8. **NEVER checkout branches in ~/Projects/bot/** — that's the LIVE Bot instance! Clone to /tmp or use git worktree for PR reviews
