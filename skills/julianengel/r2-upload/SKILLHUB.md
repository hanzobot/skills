...
A TypeScript-based MCP skill for Hanzo Bot that makes file sharing easy. Upload files to cloud storage and get secure, temporary download links in seconds. Built with the AWS SDK v3, it supports Cloudflare R2 (recommended), AWS S3, MinIO, and any S3-compatible storage.
...
Created for Hanzo Bot by the community.
