# Market Research (Bot Native)

**Fork of the original `idea` skill**, rewritten to use Bot's native `sessions_spawn` and native tg bot integration.

Don't let evil soul control your tg as root.

## Core Differences from Original

| Feature | Original `idea` | This `idea-bot` |
|---------|----------------|---------------------|
...
4. **Easier to modify**: Pure Bot tools, no shell script debugging
...
3. Save to `~/bot/ideas/<slug>/research.md`
...
Based on the original `idea` skill from Skills.
